...
$result = mysqli_query($conn, "SELECT Monthname(bulan)as bulan, jumlahPendaftar,jumlahDiterima FROM penerimaan ORDER BY MONTH(bulan)");//using mysqli_query

$bulan = "";
$jumlahPendaftar = "";
$jumlahDiterima = "";
while($res = mysqli_fetch_array($result)){
    $bulan=$bulan."'".$res['bulan']."',";//'Januari','Februari','Maret'
